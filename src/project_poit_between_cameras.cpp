                                        ...
                                        const cv::Point3f &rotation_b, int img_width, int img_height)
{
    ...
    // sphere coord to uv
    float u2 = new_point_b.y * img_width / (2 * CV_PI);
